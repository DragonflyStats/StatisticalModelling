...
%	\item[(i.)] (2 Marks) Describe the purpose of Tukey's Ladder (referencing direction and relative strength).
...
\begin{itemize}
	\item[(i.)] (2 Marks)
	State the regression equation for this model. (Use 4 decimal places.) % of the regression line.
...
%	Explain in which way is the prediction intervals different from the confidence intervals for fitted values in linear regression?
