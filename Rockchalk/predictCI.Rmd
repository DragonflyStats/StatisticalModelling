...
predicted values of GLMs, thatâs a major worry. This function takes the simplest route, calculating
...
suggests in r-help (2010). Iâd rather use one of the fancy tools like Edgeworth expansion, but that R
