...
Legal elements are c("min", "med", "max", "mean", "sd", "var","skewness", "kurtosis", The statistics c("entropy", "normedEntropy") are available only for factor variables, while mean, variance, and so forth will be calculated only for numeric
