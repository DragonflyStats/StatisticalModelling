...
* divider An algorithm name from c("quantile", "std.dev", "seq", "table") or a user-provided function. This sets the method for selecting values of the predictor. 
Documentation
for the rockchalk methods can be found in the functions cutByQuantile, cutBySD, plotSeq, and cutByTable,.
* n Default = 5. The number of values for which predictions are sought.
... Optional Arguments
 to be passed to the predict function. In particular, the Arguments
...
```{r}(m1.p1 <- predictOMatic(m1, divider = "std.dev", n = 5))
